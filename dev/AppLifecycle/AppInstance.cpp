...
namespace winrt::Microsoft::ProjectReunion::implementation
{
    ...
    Microsoft::ProjectReunion::AppInstance AppInstance::GetCurrent()
    {
        auto initInstance = []
        {
        ...
        return s_instance.as<Microsoft::ProjectReunion::AppInstance>();
    }

    IVector<Microsoft::ProjectReunion::AppInstance> AppInstance::GetInstances()
    {
        IVector<Microsoft::ProjectReunion::AppInstance> instances{ winrt::single_threaded_vector<Microsoft::ProjectReunion::AppInstance>() };
    ...
    Microsoft::ProjectReunion::AppInstance AppInstance::FindForKey(std::wstring const& key)
    {
